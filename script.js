...
/* ═══════════════════════════════
   ...
   ═══════════════════════════════ */
(function () {
  var words = ['Seguras', 'Limpias', 'Accesibles', 'A tu Medida'];
  var idx   = 0;
...
document.getElementById('cForm').addEventListener('submit', function (e) {
  ...
  var txt = '*Solicitud de Cotización — Bodegas Moshe*\n\n';
  txt += '• Nombre: '    + nombre  + '\n';
  if (empresa) txt += '• Empresa: ' + empresa + '\n';
  txt += '• Teléfono: '  + tel     + '\n';
  if (email)   txt += '• Correo: '  + email   + '\n';
  txt += '• ¿Qué necesita guardar?: ' + tipo    + '\n';
  txt += '• Descripción: '      + mensaje;

  window.open('https://wa.me/527773388384?text=' + encodeURIComponent(txt), '_blank');
});
